        ...
        if viewModel.isLoading {
            LoadingView()
                .onAppear {
                    Task {
                        Task {
                            await viewModel.getStartedProgram()
                        }
                    }
                }
        } else {
            List {
                ...
                Section {
                    ...
                    HStack {
                        ...
                        if let programId = viewModel.startedProgram {
                            Menu {
                                Button {
                                    Task {
                                        navigationController.push(.ProgramDetailView(programId: programId, removeProgram: nil))
                                    }
                                } label: {
